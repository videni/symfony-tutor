...
use Acme\DemoBundle\Util\CanonicalizerInterface;
...
abstract class UserManager implements UserManagerInterface, UserProviderInterface
{
     ...
     * all ACL checks.
     *
     * @deprecated Use Acme\DemoBundle\Security\UserProvider instead
     *
    ...
    {
        trigger_error('Using the UserManager as user provider is deprecated. Use Acme\DemoBundle\Security\UserProvider instead.', E_USER_DEPRECATED);
        ...
        if (!$user instanceof User) {
            throw new UnsupportedUserException(sprintf('Expected an instance of Acme\DemoBundle\Model\User, but got "%s".', get_class($user)));
        }
